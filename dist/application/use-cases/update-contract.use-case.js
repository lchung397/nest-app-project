...
let UpdateContractUseCase = class UpdateContractUseCase {
    contractRepository;
    constructor(contractRepository) {
        this.contractRepository = contractRepository;
    }
    async execute(userId, contractId, dto) {
        const contract = await this.contractRepository.findById(contractId);
        if (!contract) {
            throw new common_1.NotFoundException('Contract not found');
        }
        if (contract.userId !== userId) {
            throw new common_1.ForbiddenException('You can only update your own contracts');
        }
...
exports.UpdateContractUseCase = UpdateContractUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(contract_repository_interface_1.IContractRepository)),
    __metadata("design:paramtypes", [Object])
], UpdateContractUseCase);
//# sourceMappingURL=update-contract.use-case.js.map